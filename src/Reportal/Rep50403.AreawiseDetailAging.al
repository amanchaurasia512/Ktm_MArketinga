report 50403 "Area wise Detail Aging"
{
    DefaultLayout = RDLC;
    RDLCLayout = './AreawiseDetailAging.rdlc';
    Caption = 'Area wise Detail Aging';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                begin
                    ...
                    // GrandAmount1 += AmountGroup1;
                    // GrandAmount2 += AmountGroup2;
                    // GrandAmount3 += AmountGroup3;
                    // //GrandAmount4 += AmountGroup4;
                    //MESSAGE(FORMAT(GrandAmount1));
                    //MESSAGE(FORMAT(GrandAmount4));
                    // GrandAmount5 += AmountGroup5;
                    //KMT2016CU5 <<
