report 50459 "Purchase Sales Stock Statement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PurchaseSalesStockStatement.rdlc';
    Caption = 'Purchase Sales Stock Statement';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            column(CNTotal; CNTotal)
            {
            }
            column(DNTotal; DNTotal)
            {
            }
            ...
            begin
                ...
                IF StartDate > 0D THEN BEGIN
                    ...
                    ValueEntry.CALCSUMS("Item Ledger Entry Quantity", "Cost Amount (Actual)", "Cost Amount (Expected)", "Invoiced Quantity"); //pram
                ...
                ValueEntry.SETFILTER(
                  "Item Ledger Entry Type", '%1|%2|%3|%4|%5',
                ...
                ValueEntry.CALCSUMS("Item Ledger Entry Quantity", "Cost Amount (Actual)", "Cost Amount (Expected)", "Invoiced Quantity", "Sales Amount (Actual)"); //pram
                ...
                //pram
                SalesValue += ValueEntry."Sales Amount (Actual)";
            ...
            begin
                ...
                CurrReport.CREATETOTALS(
                  ...
                  StartingInvoicedValue, IncreaseInvoicedValue, DecreaseInvoicedValue, SalesValue,//pram
                  CostPostedToGL, ExpCostPostedToGL, InvCostPostedToGL);
                ...
                CustLedgerEntries.SETFILTER("Document No.", 'CN*');
                CustLedgerEntries.CALCSUMS("Sales (LCY)");
                CNTotal := CustLedgerEntries."Sales (LCY)";
                CustLedgerEntries.RESET;
                CustLedgerEntries.SETFILTER("Document No.", 'DN*');
                CustLedgerEntries.SETRANGE("Posting Date", StartDate, EndDate);
                CustLedgerEntries.CALCSUMS("Sales (LCY)");
                DNTotal := CustLedgerEntries."Sales (LCY)";
