report 50065 "Sales Invoice Confirmation KMT"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalesInvoiceConfirmationKMT.rdlc';
    Caption = 'Sales Order';
    ...
    dataset
    {
        dataitem(DataItem6640; Table36)
        {
            ...
            column(Note_SalesHeader; "Sales Header".Note)
            {
            }
            ...
            dataitem(CopyLoop; Table2000000026)
            {
                ...
                dataitem(PageLoop; Table2000000026)
                {
                    ...
                    column(PostingDate_SalesHeader; FORMAT("Sales Header"."Posting Date"))
                    {
                    }
                    ...
                    dataitem(RoundLoop;Table2000000026)
                    {
                        ...
                        column(NonTaxSales;NonTaxSales)
                        {
                        }
                        ...
                        column(Desc2_SalesLine;SalesLineDesc2)
                        {
                        }
                        ...
                        column(LineDiscAmt;SalesLine."Inv. Discount Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(TotalTexts;TotalText)
                        {
                        }
                        ...
                        begin
                            ...
                            IF SalesLine."VAT %" = 0 THEN
                              NonTaxSales := SalesLine."Line Amount";
            ...
            begin
                ...
                //CustomerOneLineAddress := "Sales Header"."Sell-to Address" + ','+"Sales Header"."Sell-to Address 2"+','+"Sales Header"."Sell-to City";
                //MESSAGE(CustomerOneLineAddress);
                //NP15.1001 <<
