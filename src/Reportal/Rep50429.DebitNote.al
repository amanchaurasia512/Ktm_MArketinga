    ...
    dataset
    {
        dataitem("G/L Entry"; "G/L Entry")
        {
            ...
            begin
                ...
                IF "G/L Entry"."Party Type" = "G/L Entry"."Party Type"::Vendor THEN BEGIN
                    Vendor.SETRANGE("No.", "Party No.");
                    IF Vendor.FIND('-') THEN BEGIN
                        CustomerName := Vendor.Name + ' ' + Vendor."Name 2";
                        NameCaption := 'Vendor';
                        IF (Vendor."Address 2" <> '') AND (Vendor.City <> '') THEN
                            CustomerAddress := Vendor.Address + ',' + Vendor."Address 2" + ',' + Vendor.City
                        ELSE
                            CustomerAddress := Vendor.Address + ',' + Vendor.City;
                        CustomerNumber := Vendor."Phone No.";
                        CustomerVAT := Vendor."VAT Registration No.";
                    END;
                END ELSE
