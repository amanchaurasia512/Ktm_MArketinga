report 50448 "LC Detail Trial Balance 1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LCDetailTrialBalance1.rdlc';
    ...
    dataset
    {
        dataitem("Document Class Master"; "Document Class Master")
        {
            ...
            RequestFilterFields = "Date Filter", "Doc. Class Type", "Doc. Class No.", "Global Dimension 1 Filter", "Global Dimension 2 Filter", "G/L Account Filter";
            ...
            dataitem("G/L Entry"; "G/L Entry")
            {
                ...
                begin
                    /*IF DateFilter <> '' THEN
                      "G/L Entry".SETFILTER("Posting Date",DateFilter);*/
    ...
    trigger OnPreReport()
    begin
        DocClassFilter := "Document Class Master".GETFILTERS;
        DateFilter := "Document Class Master".GETFILTER("Date Filter");
        GLAccFilter := "Document Class Master".GETFILTER("G/L Account Filter");
        CompanyInfo.GET;
        IF DateFilter <> '' THEN BEGIN
            ...
            StartEngDate := "Document Class Master".GETRANGEMIN("Date Filter");
            EndEngDate := "Document Class Master".GETRANGEMAX("Date Filter");
            NepaliCal.RESET;
