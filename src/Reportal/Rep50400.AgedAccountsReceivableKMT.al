report 50400 "Aged Accounts Receivable KMT"
{
    DefaultLayout = RDLC;
    RDLCLayout = './AgedAccountsReceivableKMT.rdlc';
            ...
            dataitem(DataItem8503; "Cust. Ledger Entry")
            {
                ...
                begin
                    ...
                    IF AreaCode_Filter <> '' THEN
                        "Cust. Ledger Entry".SETFILTER("Cust. Ledger Entry"."Global Dimension 2 Code", AreaCode_Filter);
                    IF ProductCode_FIlter <> '' THEN
                        "Cust. Ledger Entry".SETFILTER("Cust. Ledger Entry"."Global Dimension 1 Code", ProductCode_FIlter);
                    //KMT2016CU5 <<
                end;
            }
