report 50430 "Demand Loan Detail Trial Bal."
{
    DefaultLayout = RDLC;
    RDLCLayout = './DemandLoanDetailTrialBal.rdlc';
    ...
    dataset
    {
        dataitem("Document Class Master";"Document Class Master")
        {
            ...
            dataitem("G/L Entry";"G/L Entry")
            {
                ...
                column(Demand_Loan_GLEntry;"G/L Entry"."Demand loan")
                {
                }
            ...
            begin
                ...
                OpeningBalance := 0;
                GLEntry.RESET;
                GLEntry.SETFILTER("Demand loan","Doc. Class No.");
            ...
            begin
                RESET;
                SETRANGE("Doc. Class Type","Doc. Class Type"::"Demand loan" );
            end;
        }
    }
    ...
    var
        ...
        ReportHeading: Label 'Demand Lona Detail Trial Bal.';
        ShowSummary: Boolean;
        DrCrIndication: Text;
        OpeningBalDrCr: Text;
        GLAccFilter: Code[20];
