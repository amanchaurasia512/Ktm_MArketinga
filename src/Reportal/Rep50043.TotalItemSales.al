report 50043 "Total Item Sales"
{
    DefaultLayout = RDLC;
    RDLCLayout = './TotalItemSales.rdlc';
    ...
    dataset
    {
        dataitem(Item;Item)
        {
            ...
            column(RBIProductCode; Item."RBI Product Code")
            {
            }
    ...
    var
        ...
        Inventory_ValuationCaptionLbl: Label 'Item Sales Report';
